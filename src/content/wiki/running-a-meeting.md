...
description: How to run engaging, productive Hack Club meetings that members actually want to come back to.
categories: ["Clubs"]
...
4. Lead by example — demo your own work
...
- [workshops.hackclub.com](https://workshops.hackclub.com) — curated workshop library
- `#club-leaders` on Slack — ask other leaders for advice
